...
I {{resource:Common_Company_Name_Short}} är det enkelt att spara ner företagets historiska data för att uppfylla lagkrav på arkivering. Genom den nya exportfunktionen kan du ladda ner all dokumentation för ett eller flera räkenskapsår i ett smidigt, komprimerat format (ZIP-fil).
