...
title: Enklare och smartare påminnelsehantering med Visma Amili
slug: enklare-och-smartare-paminnelsehantering-med-visma-amili
languages:
  - sv
  - en
format: md
...
updatedAt: '2026-01-27T18:43:02.197Z'
publishedAt: null
pendingReview: false
...
När sista betalningsdagen på en faktura har passerat kan du välja att skicka en påminnelse via {{resource:common_product_name_variable_amili}}. Det gör du enkelt antingen inifrån den specifika fakturan eller direkt i listan över alla dina fakturor. 

När du har skickat ärendet tar {{resource:common_product_name_variable_amili}} över och sköter kontakten med din kund på ett professionellt sätt som vårdar din kundrelation. Om fakturan betalas och du har en bankkoppling till Spiris, bokförs betalningen automatiskt och ärendet hos {{resource:common_product_name_variable_amili}} avslutas direkt.
...
*   **Enkel länk till portalen:** Om du behöver se mer detaljerad historik finns en direktlänk till {{resource:common_product_name_variable_amili}}s egen sida där du hittar all information om ärendet.
...
Börja använda påminnelsehanteringen redan idag! Låt programmet sköta uppföljningen åt dig, så att du kan fokusera på det du gör bäst – att driva ditt företag.
