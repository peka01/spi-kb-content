...
translationBase:
  en: >-
    ...
    2. Sök upp eller välj bilagan **Skattemässiga avskrivningar på maskiner och
    inventarier** i listan.

    3. Kontrollera att det **Ingående bokförda värdet** stämmer överens med
    föregående års avslut.
