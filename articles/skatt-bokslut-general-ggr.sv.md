...
updatedAt: '2025-12-21T15:34:44.204Z'
publishedAt: null
pendingReview: true
reviewedAt: null
lastLLMUpdateAt: '2025-12-21T15:34:44.204Z'
metadata:
  tags:
    - update
    - general
...
5. Du kan följa förloppet via en statusmätare, på samma sätt som i rapportcentralen. När exporten är klar laddas en zip-fil ner till din dator och ett bekräftelsemeddelande visas.
...
*   **Om något går fel:** Skulle en enskild fil inte kunna skapas (exempelvis på grund av ett ovanligt filformat) får du ett meddelande om att rapporten delvis misslyckades men ändå skapades. I zip-filen ersätts det dokument som inte kunde skapas med en vit sida som förklarar vilken fil det gäller och vad som gick fel, så att du kan kontrollera detta manuellt.
*   **Tillgänglighet:** Funktionen är tillgänglig för både aktiva användare (både VPY Pro och VPY noninteractive) och för dig som har läsrättigheter till plattformen.
